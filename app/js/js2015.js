...
$(document).ready(function () {
    var $window = $(window);
    var $nav = $('.products__nav');
    var $menuLarge = $('.menu__large');
    var $largeMenuWrapper = $('.wrapper');
    var $mainMenuLinks = $('.wrapper__nav .nav__item');
    var navOffsetTop = $('.products__nav').offset().top;
    var $secondSectionStart = $('.explained').offset().top;
    var $lastSectionStart = $('.shop').offset().top;
    var $lastSectionHeight = $('.shop').height();
    var $path1 = $('.svgPath1');
    var $path2 = $('.svgPath2');
    var $path3 = $('.svgPath3');
    ...
    $(document).on('click', '.footer .nav__item, .footer a, .shop__link', function (e) {
        e.preventDefault();
    });
    ...
    function goToLink(e) {
        e.preventDefault();
        var navHeight = $('.products__nav').height();
    ...
    function animateMenuOpen() {
        ...
        tlMenu.to($largeMenuWrapper, .3, { left: '0%', ease: Power3.easeOut }).staggerTo($mainMenuLinks, 0.5, { x: '0%', opacity: 1 }, 0.1).to($path1, 0.7, { strokeDashoffset: 0, ease: Power1.easeInOut }).to($path1, 0.4, { fill: '#fff' }, '-=0.3').to($path2, 0.7, { strokeDashoffset: 0, ease: Power1.easeInOut }).to($path2, 0.4, { fill: '#fff' }, '-=0.3').to($path3, 1, { strokeDashoffset: 0, ease: Power1.easeInOut }).to($path3, 0.4, { fill: '#fff', onComplete: function onComplete() {
    ...
    function animateMenuClose() {
        var tlMenu = new TimelineMax();
        tlMenu.staggerTo($mainMenuLinks, .3, { x: '-30%', opacity: 0 }, 0.1).set($path1, { strokeDashoffset: 493.69 }).set($path1, { fill: 'transparent' }).set($path2, { strokeDashoffset: 303.76 }).set($path2, { fill: 'transparent' }, '-=0.3').set($path3, { strokeDashoffset: 3457.30 }).set($path3, { fill: 'transparent' }, '-=0.3').to('.wrapper', .1, { left: '-30%', ease: Power3.easeOut, onComplete: function onComplete() {
    ...
    function navActiveClass() {
        $('.navPosition').each(function (i, el) {
            ...
            var $menuLink1 = $('.products__link:first-child');
            var $menuLink4 = $('.products__link:last-child');
    ...
    function stickyNavigation() {
        var winOffTop = $(window).scrollTop();
        var sticky = winOffTop >= navOffsetTop;
        if (sticky) {
            $nav.addClass('sticky');
        } else {
    ...
    function trackSwipe() {
        if (menuOpened) {
            var swipeStart = '';
            $largeMenuWrapper.on("touchstart", function (e) {
                swipeStart = e.changedTouches[0].pageX;
            });
            $largeMenuWrapper.on("touchend", function (e) {
